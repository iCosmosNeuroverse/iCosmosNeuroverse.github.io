...
{
	//[micah.note]use bitwise operation '>> 0' to collapse decimal.
...
function updatePositions() {
  ...
  node.attr("r", function(d) { return 5 + Math.sqrt(d.size) / 2; })
	...
	{
		//[micah.note _ essentially sets speed per page reload per ux control toggle]
